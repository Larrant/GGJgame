...
label end2:
    ...
    "..."
    "I'm tired."
    "I sit down and turn to a different page in the notebook. I take out the pen."
    "I remember..."
    scene bg memory
    ...
    "Axel's gone."
    "He left."
    p "...That means at least he won't forget, right?"
    p "..."
...
label end3:
    ...
    a "Loy."
    l "Yeah?"
    "But then there's a silence. Axel doesn't say anything."
    "I get it, I suppose."
